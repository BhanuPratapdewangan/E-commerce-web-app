...
//         // var updateQuery = {$set: {ProductName: req.body.ProductName, Price:req.body.Price, Stock:req.body.Stock, CategoryName: req.body.CategoryName}}

//         database.collection("products").updateOne({ProductId : id},{$set: {ProductName: req.body.ProductName, Price:req.body.Price, Stock:req.body.Stock, CategoryName: req.body.CategoryName}}).then(result => {
